                ...
                <div class="col-sm-12">
                    <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                        ...
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white fw-500">Signup</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-5 col-xxl-4">
                    <div class="login-form-area">
                        ...
                        <form class="login-form">
                            ...
                            <input type="name" placeholder="Enter your email" class="w-100 rounded">
                            ...
                            <p class="text-xl-center mt-4">Don't have an account? <a href="singup.html">Sign Up</a></p>
                        </form>
                    </div>
                </div>
