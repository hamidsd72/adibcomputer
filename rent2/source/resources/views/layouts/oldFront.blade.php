...
<head>
    ...
    @else
        <meta property="og:image" content="{{url('assets/front/logo_1.png')}}" />
    @endif
...
{{--    <meta name="robots" content="index, follow" />--}}
    ...
    <!-- icon -->
    <link rel="icon" href="{{url('assets/front/logo_1.png')}}" type="image/x-icon">
    <!-- Bootstrap css-->
                    ...
                    <div class="col-lg-8 col-md-9 position-relative d-none d-md-block">
                        @if($header_banner)
                            <a href="{{route('front.seen',['banner',$header_banner->id])}}">
                                <img src="{{url($header_banner->pic)}}" class="banner_header" alt="هنر آفرین">
                            </a>
                        @endif
                    </div>
                    <div class="col-lg-4 col-md-3 position-relative">
                        <a href="{{route('front.index')}}">
                            <img src="{{url('assets/front/logo_8.png')}}" class="logo_top" alt="هنر آفرین">
                        </a>
                    </div>
